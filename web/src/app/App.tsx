...
"
    ...
    "
      ...
      <section
        id="contact"
        className="py-20 bg-[#D72626] relative overflow-hidden"
      >
        <div
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="font-['Poppins',sans-serif] font-black text-3xl sm:text-4xl lg:text-5xl text-white mb-4">
            Need Reliable Roofing Solutions?
          </h2>
          <p className="text-red-100 text-lg mb-10 max-w-2xl mx-auto">
            Get a free, no-obligation estimate from Assam&apos;s trusted roofing
            specialists. We respond within 24 hours.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href={callHref}
              className="flex items-center gap-2.5 px-8 py-4 rounded-xl bg-white text-[#D72626] font-bold text-base hover:bg-red-50 transition-all shadow-lg active:scale-95"
            >
              <Phone className="w-5 h-5" /> +91 63702 68346
            </a>
            <a
              href={waHref}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 px-8 py-4 rounded-xl bg-[#25D366] text-white font-bold text-base hover:bg-[#1fba58] transition-all shadow-lg active:scale-95"
            >
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-6 text-white/80 text-sm">
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-white" /> Free Estimate
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-white" /> No Obligation
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-white" /> Fast Response
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-white" /> Serving Assam
              Since 2015
            </span>
          </div>
        </div>
